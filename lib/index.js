            ...
            .spread(function (dreply, search) {
                ...
                .then(function () {
                    if (_tfs.options.events) {
                        _tfs.emit('share:dst', dstPath, new Stats(tdir, readOnly));
                    }
                });
            });
        })
        .then(function () {
            ...
            .then(function () {
                if (self.options.events) {
                    self.emit('share:src', _path, new Stats(dir));
                }
            });
        });
    })
    ...
    return this._readLink(__path).spread(function (fs, _path) {
        ...
        .then(function (reply) {
            ...
            if (dir.share && dir.share.to.length) {
                ...
                .then(function () {
                    if (fs.options.events) {
                        fs.emit('unshare:src', _path, new Stats(dir));
                    }
                });
            }
            ...
            return _tfs.riak.get({
                ...
                .then(function () {
                    if (_tfs.options.events) {
                        ...
                        _tfs.emit('unshare:dst', __path, new Stats(dreply.content[0].value));
                    }
                });
            });
        });
