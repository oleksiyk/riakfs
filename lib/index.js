...
RiakFs.prototype.unlink = function(filename, callback) {
    return this.checkShared(filename).spread(function(fs, filename) {
        return fs.riak.get({
...
RiakFs.prototype.open = function(filename, flags, mode, callback) {
    ...
    return self.checkShared(filename).spread(function(fs, filename) {
...
RiakFs.prototype.share = function(_path, root, alias, callback) {
