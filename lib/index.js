...
RiakFs.prototype.unlink = function(filename, callback) {
    return this.checkShared(filename).spread(function(fs, filename, readOnly) {
        if(readOnly){
            throw new RiakFsError('EACCES', 'Readonly share: ' + filename)
        }
...
RiakFs.prototype.readdir2 = function(_path, max, marker, callback) {
    ...
    return self.checkShared(_path).spread(function(fs, _path) {
...
RiakFs.prototype.mkdir = function(_path, mode, callback) {
    ...
    return this.checkShared(_path).spread(function(fs, _path, readOnly) {
        ...
        if(readOnly){
            throw new RiakFsError('EACCES', 'Readonly share: ' + _path)
        }
...
RiakFs.prototype.open = function(filename, flags, mode, callback) {
    ...
    return self.checkShared(filename).spread(function(fs, filename, readOnly) {
