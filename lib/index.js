    ...
    return Promise.all([
        self.riak.setBucket({
            ...
            props: {
                ...
                n_val: self.options.riak.cap.n_val,
                pr: self.options.riak.cap.pr,
                r: self.options.riak.cap.r,
                w: self.options.riak.cap.w,
                pw: self.options.riak.cap.pw,
                dw: self.options.riak.cap.dw,
                rw: self.options.riak.cap.rw,
                basic_quorum: self.options.riak.cap.basic_quorum,
                backend: self.options.riak.cap.meta_backend
            }
        }),
        self.riak.setBucket({
            ...
            props: {
                ...
                rw: self.options.riak.cap.rw,
                basic_quorum: self.options.riak.cap.basic_quorum,
                backend: self.options.riak.cap.chunks_backend
            }
        })
    ])
}
...
RiakFs.prototype.open = function(filename, flags, mode, callback) {
    ...
    mode = _.partialRight(_.merge, _.defaults)(mode || {}, {
        r: void 0, // get, del
        w: void 0, // put, del
        pr: void 0, // get, del
        pw: void 0, // put, del
        dw: void 0, // put, del
        basic_quorum: void 0 // get
    });
    */
