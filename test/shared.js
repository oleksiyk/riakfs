...
describe('#shared directory', function() {
    ...
    it('should fail for /Shared with Me', function() {
        return riakfs1.share('/Shared with Me', riakfs2.options.root, 'fs1-dir1').should.be.rejected.and.eventually.have.property('code', 'EINVAL');
    });
    ...
    it('should not allow sharing when target path is a file', function() {
        return riakfs2.mkdir('/Shared with Me').then(function() {
            return riakfs2.writeFile('/Shared with Me/file1', 'hello').then(function() {
    ...
    it('should not allow sharing when target dir is not empty', function() {
        return riakfs2.mkdir('/Shared with Me/dir1').then(function() {
            return riakfs2.writeFile('/Shared with Me/dir1/file1', 'hello').then(function() {
    ...
    it('should create target shared directory', function() {
        return riakfs1.share('/dir1', riakfs2.options.root, 'fs1-dir1').then(function() {
            return riakfs2.stat('/Shared with Me/fs1-dir1').then(function(stats) {
    ...
    it('should share directory from /Shared', function() {
        return riakfs1.makeTree('/Shared with Me/dir').then(function () {
            return riakfs1.share('/Shared with Me/dir', riakfs2.options.root, 'fs1-shared-dir').then(function() {
                return Promise.all([
                    riakfs1.stat('/Shared with Me/dir'),
                    riakfs2.stat('/Shared with Me/fs1-shared-dir')
    ...
    it('should not allow re-sharing', function() {
        return riakfs2.share('/Shared with Me/fs1-dir1', riakfs3.options.root, 'fs2-dir1').should.be.rejected.and.eventually.have.property('code', 'ESHARED');
    });

    it('should not allow deep re-sharing', function() {
        return riakfs2.share('/Shared with Me/fs1-dir1/dir2',
    ...
    it('should create readonly target shared directory', function() {
        return riakfs1.share('/dir1', riakfs3.options.root, 'fs1-dir1', true).then(function() {
            return riakfs3.stat('/Shared with Me/fs1-dir1').then(function(stats) {
                stats.should.be.an('object');
                stats.file.should.have.property('share').that.is.an('object');
                stats.file.share.should.have.property('owner').that.is.an('object');
                stats.file.share.owner.root.should.be.eql(riakfs1.options.root);
    ...
    it('#readdir', function() {
        return riakfs2.readdir('/Shared with Me/fs1-dir1').then(function(list) {
            list.should.contain('dir2').and.contain('file1');
        });
    });

    it('#readdir - readonly', function() {
        return riakfs3.readdir('/Shared with Me/fs1-dir1').then(function(list) {
            list.should.contain('dir2').and.contain('file1');
        });
    });
    ...
    it('#stat', function() {
        return riakfs2.stat('/Shared with Me/fs1-dir1/file1').then(function(stats) {
            stats.should.be.an('object');
    ...
    it('#stat - readonly', function() {
        return riakfs3.stat('/Shared with Me/fs1-dir1/file1').then(function(stats) {
            stats.should.be.an('object');
            stats.isFile().should.eql(true);
            stats.size.should.be.eql(5);
    ...
    it('#exists', function() {
        return riakfs2.exists('/Shared with Me/fs1-dir1/file1').then(function(exists) {
            return exists.should.be.true;
        });
    });

    it('#exists - readonly', function() {
        return riakfs3.exists('/Shared with Me/fs1-dir1/file1').then(function(exists) {
            return exists.should.be.true;
        });
    });

    it('#readFile', function() {
        return riakfs2.readFile('/Shared with Me/fs1-dir1/file1', {encoding: 'utf8'}).then(function(data) {
    ...
    it('#readFile - readonly', function() {
        return riakfs3.readFile('/Shared with Me/fs1-dir1/file1', {encoding: 'utf8'}).then(function(data) {
            data.length.should.be.eql(5);
            data.should.be.a('string').and.eql('hello');
        });
    });
    ...
    it('#writeFile', function() {
        return riakfs2.writeFile('/Shared with Me/fs1-dir1/file2', 'hello2').then(function() {
    ...
    it('#writeFile - readonly', function() {
        return riakfs3.writeFile('/Shared with Me/fs1-dir1/file2', 'hello2').should.be.rejected.and.eventually.have.property('code', 'EACCES');
    });

    it('#updateMeta', function() {
        var file = {
            filename: '/Shared with Me/fs1-dir1/testFile',
            meta: {
                someKey: 'someValue'
            }
        };
    ...
    it('#unlink', function() {
        return riakfs2.unlink('/Shared with Me/fs1-dir1/file2').then(function() {
            return riakfs1.stat('/dir1/file2').should.be.rejected.and.eventually.have.property('code', 'ENOENT');
        });
    });

    it('#unlink - readonly', function() {
        return riakfs3.unlink('/Shared with Me/fs1-dir1/file1').should.be.rejected.and.eventually.have.property('code', 'EACCES');
    });

    it('#mkdir', function() {
        return riakfs2.mkdir('/Shared with Me/fs1-dir1/dir3').then(function() {
    ...
    it('#mkdir - readonly', function() {
        return riakfs3.mkdir('/Shared with Me/fs1-dir1/dir4').should.be.rejected.and.eventually.have.property('code', 'EACCES');
    });

    it('#rmdir', function() {
        return riakfs2.rmdir('/Shared with Me/fs1-dir1/dir3').then(function() {
            return riakfs1.stat('/dir1/dir3').should.be.rejected.and.eventually.have.property('code', 'ENOENT');
        });
    });

    it('#rmdir - readonly', function() {
        return riakfs3.rmdir('/Shared with Me/fs1-dir1/dir1').should.be.rejected.and.eventually.have.property('code', 'EACCES');
    });

    it('#copy', function() {
        return riakfs2.writeFile('/testFile', 'hello').then(function() {
            return riakfs2.copy('/testFile', '/Shared with Me/fs1-dir1/testFileCopy');
        })
        .then(function() {
    ...
    it('#copy - readonly', function() {
        return riakfs3.writeFile('/testFile', 'hello').then(function() {
            return riakfs3.copy('/testFile', '/Shared with Me/fs1-dir1/testFileCopy').should.be.rejected.and.eventually.have.property('code', 'EACCES');
        });
    });

    it('#copy - readonly - reverse', function() {
        return riakfs3.copy('/Shared with Me/fs1-dir1/file1', '/testFile1Copy').then(function() {
    ...
    it('#makeTree', function() {
        return riakfs2.makeTree('/Shared with Me/fs1-dir1/aa/bb/cc').then(function() {
    ...
    it('#makeTree - readonly', function() {
        return riakfs3.makeTree('/Shared with Me/fs1-dir1/aa1/bb1/cc1').should.be.rejected.and.eventually.have.property('code', 'EACCES');
    });

    it('#unshare - source', function() {
        return riakfs1.unshare('/dir1', riakfs3.options.root).then(function() {
            return riakfs3.stat('/Shared with Me/fs1-dir1').should.be.rejected.and.eventually.have.property('code', 'ENOENT');
        });
    });

    it('#unshare - destination', function() {
        return riakfs2.unshare('/Shared with Me/fs1-dir1').then(function() {
            return Promise.all([
                riakfs2.stat('/Shared with Me/fs1-dir1').should.be.rejected.and.eventually.have.property('code', 'ENOENT'),
    ...
    it('#rmdir - shared folder', function() {
        return riakfs1.share('/dir2', riakfs2.options.root, 'fs1-dir2').then(function() {
            return Promise.all([
                riakfs2.rmdir('/Shared with Me/fs1-dir2').should.be.rejected.and.eventually.have.property('code', 'ESHARED'),
    ...
    it('#rename - should handle source dir renaming', function() {
        ...
        .then(function() {
            return Promise.all([
                riakfs2.readdir('/Shared with Me/fs1-dir1-dir2').then(function(list) {
                    list.should.contain('file1');
                }),
                riakfs3.readdir('/Shared with Me/fs1-dir1-dir2').then(function(list) {
                    list.should.contain('file1');
                }),
    ...
    it('#rename - should handle source dir renaming for dir inside /Shared', function() {
        return riakfs1.rename('/Shared with Me/dir', '/Shared-dir-renamed')
        .then(function() {
            return Promise.all([
    ...
    it('#rename - should handle source dir renaming for dir inside /Shared (back)', function() {
        return riakfs1.rename('/Shared-dir-renamed', '/Shared with Me/dir')
        .then(function() {
            return Promise.all([
                riakfs1.stat('/Shared with Me/dir'),
                riakfs2.stat('/Shared with Me/fs1-shared-dir')
    ...
    it('#rename - should handle rename operation inside destination shares', function() {
        return riakfs2.mkdir('/Shared with Me/fs1-dir1-dir2/dir3')
        .then(function() {
            return riakfs3.writeFile('/Shared with Me/fs1-dir1-dir2/dir3/testFile', 'hello');
        })
        .then(function() {
            return riakfs2.rename('/Shared with Me/fs1-dir1-dir2/dir3', '/Shared with Me/fs1-dir1-dir2/dir3-renamed');
        })
        .then(function() {
            return Promise.all([
                ...
                riakfs3.readdir('/Shared with Me/fs1-dir1-dir2/dir3-renamed').then(function(list) {
                    list.should.contain('testFile');
                }),
                riakfs2.readdir('/Shared with Me/fs1-dir1-dir2/dir3-renamed').then(function(list) {
                    list.should.contain('testFile');
                })
            ]);
        });
    ...
    it('#rename - inside destination shares - readonly', function() {
        ...
        .then(function() {
            return riakfs3.rename('/Shared with Me/fs1-dir3/testFile',
                '/Shared with Me/fs1-dir3/testFile-renamed').should.be.rejected.and.eventually.have.property('code', 'EACCES');
        });
    });

    it('#rename - move destination share (to itself)', function() {
        return riakfs2.rename('/Shared with Me/fs1-dir1-dir2', '/fs1-dir1-dir2').should.be.rejected.and.eventually.have.property('code', 'EINVAL');
    });

    it('#rename - move destination share (to other share)', function() {
        return riakfs1.share('/dir1-renamed', riakfs2.options.root, 'fs1-dir1')
        .then(function() {
            return riakfs2.rename('/Shared with Me/fs1-dir1-dir2', '/Shared with Me/fs1-dir1').should.be.rejected.and.eventually.have.property('code', 'EINVAL');
        });
    });

    it('#rename - /Shared with Me', function() {
        return riakfs2.rename('/Shared with Me', '/Shared-renamed').should.be.rejected.and.eventually.have.property('code', 'EINVAL');
    });

    it('#rename - rename destination share (change alias)', function() {
        return riakfs2.rename('/Shared with Me/fs1-dir1', '/Shared with Me/fs1-dir1-renamed')
        .then(function() {
            return riakfs2.readdir('/Shared with Me/fs1-dir1-renamed').then(function(list) {
                list.should.contain('dir2').and.contain('file1');
    ...
    it('#rename - move shared sub dirs between filesystems', function() {
        ...
        .then(function() {
            return riakfs2.rename('/Shared with Me/fs1-dir4/dir2', '/new');
        })
        .then(function() {
